...
Address.create(address_type: Faker::Name.name.delete("\'"), status: status_array.sample, entity: "Operational Building", street_number: "1784 rue des herbes sauvages", apt_number: "", city: "Winnipeg", zip_code: "R3X1M7", country: "Canada", notes: Faker::Types.rb_string)
